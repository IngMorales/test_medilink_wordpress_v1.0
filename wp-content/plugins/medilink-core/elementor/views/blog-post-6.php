...
$thumb_size = MEDILINK_CORE_THEME . '-size360';
	                        ...
	                        <div class="post-actions-wrapper">
	                            <ul>
	                                ...
	                                <?php if ( RDTheme::$options['blog_comment_num']): ?>
											<li class="vcard-comments"> <a href="<?php the_permalink();?>"><i class="far fa-comment"></i> <?php echo wp_kses_post( $comments_number );?></a></li>
									<?php endif; ?>	
	                            </ul>
	                        </div>
	                    </div>
