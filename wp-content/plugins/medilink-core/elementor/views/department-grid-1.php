		...
		<?php while ( $query->have_posts() ) : $query->the_post();?>
			...
			<div class="rtin-item <?php echo esc_attr( $col_class );?>">
				 <div class="departments-box-layout2">
	                <span class="departments-sl"> <?php echo esc_attr($counter2); ?></span>                        
					<?php if ( $bgimgid ){ ?>
	                      <div class="item-icon"><img src="<?php echo esc_url($bgimg); ?>" alt="<?php the_title();?>"></div>
	                ...
	                <h3 class="item-title"><a href="<?php the_permalink();?>"><?php the_title();?></a></h3>
	                 ...
	                 <?php if ( $data['departments_btn']): ?>
	                	<a class="item-btn" href="<?php the_permalink();?>"><?php echo wp_kses_post( $data['buttontext'] );?> <i class="fas fa-long-arrow-alt-right"></i></a>
	                <?php endif; ?>				
	            </div>
	        </div>
		<?php endwhile;?>
