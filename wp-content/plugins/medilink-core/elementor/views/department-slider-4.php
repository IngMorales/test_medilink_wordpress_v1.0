			...
			<?php while ( $query->have_posts() ) : $query->the_post();?>
				...
				<div class="rtin-item">
					 <div class="departments-box-layout2update">	                                         
						<?php if ( $bgimgid ){ ?>
		                      <div class="item-icon">
								<?php echo wp_get_attachment_image( $bgimgid,'full', "", array( "class" => "" ) ); ?>
							  </div>
	                    ...
	                    <h3 class="item-title"><a href="<?php the_permalink();?>"><?php the_title();?></a></h3>
	                     ...
	                     <?php if ( $data['departments_btn']): ?>
	                    	<a class="item-btn" href="<?php the_permalink();?>"><?php echo wp_kses_post( $data['buttontext'] );?> <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
	                    <?php endif; ?>				
	                </div>
                </div>
			<?php endwhile;?>
