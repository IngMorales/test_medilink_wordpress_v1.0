			                ...
			                <div class="media-body">
			                    <div class="item-content">
			                       ...
			                       <?php if ( !empty( RDTheme::$options['doctors_arc_designation_display'] ) ): ?>
			                        ...
			                        <ul class="item-btns">
			                            <li>
			                                <a href="<?php the_permalink();?>" class="item-btn btn-ghost">
			                                	<?php echo esc_html($data['buttontext2']); ?></a>
			                            </li>
			                            <li>
			                                <a href="<?php the_permalink();?>" class="item-btn btn-fill">
			                                	<?php echo esc_html($data['buttontext']); ?></a>
			                            </li>
			                        </ul>
			                    </div>
			                </div>
