...
<div class="rt-el-info-box clearfix media  rtin-<?php echo esc_attr( $data['theme'] );?> rtin-<?php echo esc_attr( $data['style'] );?>">
	<div class="rtin-icon">
		<?php if ( $data['style'] == 'style3' ): ?>
			<div class="rtin-button"><a href="<?php echo  $attr; ?>" class="rdtheme-button-3">Details &nbsp; <i class="fa fa-angle-right"></i></a></div>
		<?php endif; ?>
	...
	<div class="media-body rtin-content">
		<h2 class="media-heading rtin-title"><?php echo wp_kses_post( $title );?></h2>
