...
class Doctors_Slider extends Custom_Widget_Base {

	public function __construct( $data = [], $args = null ){

		$this->rt_name = esc_html__( 'Doctors Slider', 'medilink-core' );
		$this->rt_base = 'rt-doctors-slider';
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				'type'    => Controls_Manager::NUMBER,
				'id'      => 'number',
				'label'   => esc_html__( 'Total number of doctor', 'medilink-core' ),
				'default' => 5,
			...
			array(
				...
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Designation Display. Default: On', 'medilink-core' ),
			),		
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'appointment_btn',
				'label'       => esc_html__( 'Appointment Botton', 'medilink-core' ),
				'label_on'    => esc_html__( 'On', 'medilink-core' ),
				'label_off'   => esc_html__( 'Off', 'medilink-core' ),
				'default'     => 'yes',
			...
			array(
				...
				'condition'   => array( 'appointment_btn' => 'yes' ),
			),
			array(
				'type'    => Controls_Manager::TEXT,
				'id'    => 'buttonurl',
				...
				'condition'   => array( 'appointment_btn' => 'yes' ),
				'description' => esc_html__( ' If not selected, Default will be detail page', 'medilink-core' ),
			),
			array(
				'mode' => 'section_end',
			),
			...
			array(
				'type'    => Controls_Manager::NUMBER,
				'id'      => 'margin',
				'label'   => esc_html__( 'Doctor Item Margin', 'medilink-core' ),
				'default' => 20,
				'description' => esc_html__( 'Write Item Margin show all', 'medilink-core' ),
			),	
			array(
				'mode' => 'section_end',
			),
	...
	protected function render() {
		...
		$this->rt_load_scripts();			
			...
			switch ( $data['style'] ) {
			case 'style2':
			$template = 'doctors-slider-2';			
			break;	
			case 'style3':
			$template = 'doctors-slider-3';			
			break;	
			case 'style4':
			$template = 'doctors-slider-4';			
			break;
			case 'style5':
			$template = 'doctors-slider-5';			
			break;		
			case 'style6':
			$template = 'doctors-slider-6';			
			break;			
			default:
			$template = 'doctors-slider-1';
			break;
		}
