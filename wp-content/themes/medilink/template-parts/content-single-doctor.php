...
$address                        = get_post_meta( $id, "{$cpt}_textarea_html", true );
...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'team-single' ); ?>>
    <div class="row">
        ...
        <div class="sidebar-widget-area sidebar-break-md col-xl-3 col-lg-4 col-md-12 col-12">
            ...
            <?php if( Helper::check_string_not_empty ($values = [$_phone,$_office,$_email]) || Helper::check_string_not_empty ($socials) ){ ?>
                ...
                <div class="widgets widget-team-contact">
                    ...
                    <ul>
                        ...
                        <?php } ?>    
                         ...
                         <?php } ?> 
                        <?php if ( Helper::check_string_not_empty ($socials) && RDTheme::$options['doctor_arc_social_display'] ): ?>
           ...
           <?php if ($_emergency_cases) { ?>
            <div class="widgets widget-call-to-action">
                <div class="media">
                    <img width="52" height="57" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/figure1.png" alt="<?php esc_html_e( 'figure', 'medilink' ); ?>">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table schedule-table">
                                ...
                                <?php foreach ($_appointmnet_schedules as $schedule) {  ?> 
                                    <tr>
                                        <td class="weekday"><?php echo esc_html($schedule['week']); ?></td>
                                        <td class="weektime"><?php echo esc_html($schedule['start_time']); ?> - <?php echo esc_html($schedule['end_time']); ?></td>
										<?php if( !empty($schedule['appbtn_text']) || !empty($schedule['appbtn_link']) ) { ?>
                                            <td class="schedule-btn"><a href="<?php echo esc_url($schedule['appbtn_link']); ?>" class="item-btn"><?php echo esc_html($schedule['appbtn_text']); ?></a></td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?> 
                                </tbody>
