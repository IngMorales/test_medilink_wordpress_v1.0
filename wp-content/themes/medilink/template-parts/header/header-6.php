			...
			<div class="<?php echo esc_attr( $rdtheme_menu_class );?>">
				...
				<div class="col-lg-2 col-md-2 d-none d-lg-block">
					<div class="header-action-items">					  
					        <a href="<?php echo esc_url( RDTheme::$options['header_buttonUrl'] );?>" title="<?php echo esc_html( RDTheme::$options['header_buttontext'] );?>" class="btn-fill color-yellow btn-header">
