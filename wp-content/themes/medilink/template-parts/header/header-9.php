...
?>
<div class="masthead-container header-menu-area header-menu-layout1 header-menu-layout8 header-menu-layout9">
  <div class="container">
    <div class="row no-gutters d-flex align-items-center">
      ...
      <div class="<?php echo esc_attr( $rdtheme_menu_class );?> d-flex justify-content-end possition-static">
