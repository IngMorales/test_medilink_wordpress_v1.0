...
?>
<div class="header-top-bar rt-header-top-bar top-bar-layout-5 <?php echo esc_attr( $fullwidth_compress );?> <?php echo esc_attr( $phone_has_address );?> <?php echo esc_attr( $phone_has_mobile );?>   <?php echo esc_attr( $phone_has_social );?>" id="tophead">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-6">		
				<div class="tophead-contact header-contact-layout5 <?php echo esc_attr( $phone_has_address );?>">					
					<ul>								
			...
			<div class="col-sm-12 col-md-12 col-lg-6">
				<div class="tophead-right header-social-layout5">
					<?php if ( RDTheme::$options['phone'] ): ?>							
						<?php if ( RDTheme::$options['phone'] ): ?>
							<div class="phone-layout5 <?php echo esc_attr( $phone_has_mobile );?>">
					...
					<?php if ( $rdtheme_socials ): ?>
						<ul class="tophead-social5 <?php echo esc_attr( $phone_has_social );?>">							
